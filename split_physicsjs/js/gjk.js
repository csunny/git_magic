function Gjk(){
    ...
    this.gjkAccuracy = 0.0001;
    this.gjkMaxIterations = 100;

    // get the next search direction from two simplex points
    this.getNextSearchDir = function getNextSearchDir( ptA, ptB, dir ){
     ...
     **/
    this.getClosestPoints = function getClosestPoints( simplex ){
     ...
     * ```
     **/
    this.gjk = function gjk( support, seed, checkOverlapOnly, debugFn ){
